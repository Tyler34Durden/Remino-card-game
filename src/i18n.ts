...
const en = {
  ...
  "turn.draw": "Your turn. Draw from the stock, or take the discard if you can build a new meld with it now.",
  "turn.drawUnopened": "Your turn. Draw from the stock, or take the discard to open with {points} points.",
  ...
  "action.addHint": "Select cards, then tap a meld to add them. Select one card and tap a joker marked Swap to take that joker.",
